...
@implementation NSString (GQTextField)
...
@interface GQTextField()<UITextFieldDelegate>
@end
...
- (BOOL)validateInputString:(NSString *)string textField:(UITextField *)textField{
    switch (self.inputType) {
        case GQTextFieldTypeOnlyUnsignInt:{
            return [string isTextFieldIntValue];
        }
            break;
        case GQTextFieldTypeOnlyInt:{
            return [string isTextFieldUnsignedIntValue];
        }
            break;
        case GQTextFieldTypeForbidEmoj:{
...
-(void)setInputType:(GQTextFieldType)inputType{
...
- (void)textFieldDidBeginEditing:(UITextField *)textField{
    if(_notifyEvent){
        _notifyEvent(self,GQTextFieldEventBegin);
    }
}
...
- (void)textFieldDidEndEditing:(UITextField *)textField{
    if(_notifyEvent){
        _notifyEvent(self,GQTextFieldEventFinish);
    }
}
