...
+(UIImage*)AutorImage:(NSString*)imageName{
    ...
    if(height==480){
        ...
        return [UIImage imageNamed:[NSString stringWithFormat:@"%@5",imageName]];
        ...
        return [UIImage imageNamed:[NSString stringWithFormat:@"%@X",imageName]];
...
+ (UIImage *_Nullable)contentFileWithName:(NSString *_Nullable)fileName Type:(NSString *)type{
...
+ (UIImage *_Nullable)imageFromColor:(UIColor *_Nullable)color {
...
- (UIImage*_Nullable)transformWidth:(CGFloat)width
...
- (UIImage *_Nullable)applyTintEffectWithColor:(UIColor *_Nullable)tintColor
{
