                  ...
                  key:(NSString *)key
{
    ...
    {
        //解码 base64
        NSData *decryptData = [sText DataFormBase64String];//转成utf-8并decode
    ...
    ccStatus = CCCrypt(encryptOperation,//  加密/解密
                       ...
                       //  选项分组密码算法(des:对每块分组加一次密  3DES：对每块分组加三个不同的密)
